                    ...
                    if(term === 'Firstterm'){
                        ...
                        if(assesment === 'firstTest'){
                           ...
                           var result = await Results.findOne({regNo : req.obj.details.regNo});
                            ...
                            const result = await Results.find({regNo : req.obj.details.regNo});
                             
                            console.log(JSON.stringify(result[0].primary.studentClass.activity1.Firstterm.secondTest, null, 2));
                             return new Response('Success..', { status: 200 })
